    ...
    <section id="contact" className="lg:section py-16">
      <div className="container mx-auto">
        <div className="flex flex-col lg:flex-row">
          ...
          >
            <div>
              <h4 className="mb-2 text-xl font-bold uppercase tracking-wide text-accent">Get in touch</h4>
          ...
          >
            ...
            />
            {errors.name && <span className="font-bold text-red-700">Please fill in your name!</span>}
            <input
              className="w-full border-b bg-transparent py-3 outline-none transition-all placeholder:text-white focus:border-accent"
              type="text"
            ...
            />
            {errors.email && <span className="font-bold text-red-700">Please fill in your e-mail correctly!</span>}
            <textarea
            ...
            />
            {errors.message && <span className="font-bold text-red-700">Please fill the message box!</span>}
